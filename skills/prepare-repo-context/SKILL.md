...
2. Summarize only the returned provider availability, freshness, eligible/excluded path counts, required authorizations, and `next_safe_action`. Do not put an index, repository-wide file list, or source content into the model context.

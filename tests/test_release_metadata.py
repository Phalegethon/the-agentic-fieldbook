...
class ReleaseMetadataTest(unittest.TestCase):
    def test_native_release_workflow_preserves_cross_platform_security_contract(self) -> None:
        ...
        self.assertIn("DirectorySecurity", workflow)
        self.assertIn("SetAccessRuleProtection($true, $false)", workflow)
    ...
    def test_readme_publishes_one_taf_install_migration_and_update_path(self) -> None:
        ...
        self.assertIn("## [2.1.2] - 2026-08-31", changelog)
        self.assertIn("## [2.2.0] - 2026-09-03", changelog)
        self.assertIn("## [2.3.0] - 2026-09-04", changelog)
        self.assertIn("## [2.4.0] - 2026-09-04", changelog)
        self.assertIn("## [2.5.0] - 2026-09-05", changelog)
        self.assertIn("## [2.6.0] - 2026-09-05", changelog)
        self.assertIn("## [2.7.0] - 2026-09-05", changelog)
        self.assertIn("## [2.7.1] - 2026-09-05", changelog)
        self.assertIn("## [2.7.2] - 2026-09-05", changelog)
        self.assertIn("## [2.7.3] - 2026-09-05", changelog)
        self.assertIn("## [2.8.0] - 2026-09-05", changelog)
        self.assertIn("## [2.8.1] - 2026-09-05", changelog)
        self.assertIn("## [2.8.2] - 2026-09-05", changelog)
        self.assertIn("## [2.8.3] - 2026-09-05", changelog)
        self.assertIn("## [2.8.4] - 2026-09-05", changelog)
        self.assertIn("## [2.8.5] - 2026-09-05", changelog)
        self.assertIn("## [2.9.1] - 2026-09-06", changelog)
        for required in (
            "Install TAF once",
            "## Install TAF",
